...
const CiiBulkOutwardDialog = (props) => {
    ...
    const handleBulkOutward = async () => {
        ...
        const url = `SmOutboundStockCiis/BulkOutwardData`;
        ...
        const Data = {
            ...
            materialNumber: selectedData.map((row) => row.materialNumber),
            materialDescription: selectedData.map((row) => row.materialDescription),
        ...
        <div>
            ...
            <Dialog open={open} onClose={handleClose} maxWidth={"xl"}>
                <DialogTitle sx={{ padding: "32px 32px 32px 32px" }}>
                    <div className="dialog-title">Bulk Outward</div>
                    {/* {view === "form" ? (
                        <DropdownField
...
export default CiiBulkOutwardDialog;
